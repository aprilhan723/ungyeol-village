...
export function createWorld(container,people,onSelect){
 ...
 scene.add(new THREE.HemisphereLight(0xfff6dd,0x8a9e86,2.8));const sun=new THREE.DirectionalLight(0xffe8c2,3.5);sun.position.set(-12,25,15);sun.castShadow=true;sun.shadow.mapSize.set(2048,2048);sun.shadow.camera.left=-22;sun.shadow.camera.right=22;sun.shadow.camera.top=22;sun.shadow.camera.bottom=-22;sun.shadow.normalBias=.04;scene.add(sun);
